...
#ifdef USING_SERVO
    #define Z_SERVO_PIN             GPIO_NUM_17
    #define Z_SERVO_CAL_MIN               2.14//0.53//100%       // calibration factor for the minimum PWM duty
    #define Z_SERVO_CAL_MAX               1.23       // calibration factor for the maximum PWM duty
#endif
...
#define DEFAULT_Z_STEPS_PER_MM 4 // This is percent in servo mode...used for calibration
...
#define DEFAULT_Y_MAX_TRAVEL 260.0 // mm NOTE: Must be a positive value.
#define DEFAULT_Z_MAX_TRAVEL 1.0 // This is percent in servo mode...used for calibration
